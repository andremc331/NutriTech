...
__export(dist_exports, {
  ...
  download: () => import_chunk_PZCT5QBC.download,
  engineEnvVarMap: () => import_chunk_PXQVM7NP.engineEnvVarMap,
  getBinaryEnvVarPath: () => import_chunk_PXQVM7NP.getBinaryEnvVarPath,
  getBinaryName: () => import_chunk_PZCT5QBC.getBinaryName,
  getCacheDir: () => import_chunk_5T2KHPZI.getCacheDir,
  getProxyAgent: () => import_chunk_KDPLGCY6.getProxyAgent,
  getVersion: () => import_chunk_PZCT5QBC.getVersion,
  maybeCopyToTmp: () => import_chunk_PZCT5QBC.maybeCopyToTmp,
  overwriteFile: () => import_chunk_5T2KHPZI.overwriteFile,
  plusX: () => import_chunk_PZCT5QBC.plusX,
  vercelPkgPathRegex: () => import_chunk_PZCT5QBC.vercelPkgPathRegex
});
module.exports = __toCommonJS(dist_exports);
var import_chunk_PZCT5QBC = require("./chunk-PZCT5QBC.js");
